...
class OutflowWalletHistoryScreen extends StatefulWidget {
  const OutflowWalletHistoryScreen({Key key}) : super(key: key);

  @override
  State<OutflowWalletHistoryScreen> createState() =>
      _OutflowWalletHistoryScreenState();
}

class _OutflowWalletHistoryScreenState
    extends State<OutflowWalletHistoryScreen> {
  @override
  void initState() {
    super.initState();
        ...
        child: SafeArea(
          child: Scaffold(
            ...
            children: [
              ...
              //       children: [
              //         Customchip(
              //           title: "All",color: whiteColor,
              //           onTap: (){},

              //         ),
              //         Customchip(
              //           title: "Inflow",color: whiteColor,
              //         ),
              //         Customchip(
              //           title: "OutFlow",color: whiteColor,
              //         ),
              //       ],
              //     ),
              //   ),
              ...
              Expanded(
                child: Container(
                  child: walletProvider.loading
                      ...
                      :
                      //  FutureBuilder<List<WalletHistoryModel>>(
                      //   future: postWalletHistory(),
                      //   builder: (context, snapshot) {
                      //     if (snapshot.connectionState == ConnectionState.waiting) {
                      //       return TransactionShimmerList();
                      ...
                      ListView.builder(
                          itemCount:
                              walletProvider.walletOutflowHistoryList.length,
                          itemBuilder: (context, index) {
                            final data =
                                walletProvider.walletOutflowHistoryList[index];
                            return Padding(
