...
class FastagDthAuthenticateScreen extends StatefulWidget {
  String amount, title, txId;

  FastagDthAuthenticateScreen({Key key, this.amount, this.title, this.txId})
      : super(key: key);

  @override
  State<FastagDthAuthenticateScreen> createState() =>
      _FastagDthAuthenticateScreenState();
}

class _FastagDthAuthenticateScreenState
    extends State<FastagDthAuthenticateScreen> {
  @override
      ...
      child: Scaffold(
          ...
          body: Column(children: [
            ...
            PinCodeFields(
              ...
              obscureText: true,
              onComplete: (val) {
                authProvider.verifyYourPinFD(
                    widget.amount, widget.title, widget.txId, val, context);
              },
            ),
            // spacer30Height,
            // CustomBottomButton(
