  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
        child: Scaffold(
            ...
            body: offerProvider.loading?ShimmerListComponent():  ListView.builder(
              itemCount: offerProvider.prepaidOffer.length,
              itemBuilder: (BuildContext context, int index) {
                var jsondata = offerProvider.prepaidOffer[index].details[index];
                return InkWell(onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (_)=>MobileAuthenticateScreen(amount:jsondata.rs)));
                },
                  child: Padding(
