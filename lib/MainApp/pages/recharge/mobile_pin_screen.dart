...
class MobileAuthenticateScreen extends StatefulWidget {
  String amount;
  MobileAuthenticateScreen({Key key,this.amount}) : super(key: key);

  @override
  State<MobileAuthenticateScreen> createState() => _MobileAuthenticateScreenState();
}

class _MobileAuthenticateScreenState extends State<MobileAuthenticateScreen> {
          ...
          body: Column(children: [
            ...
            PinCodeFields(
              ...
              onComplete: (val) {
                ...
                authProvider.verifyYourPinMobile(widget.amount,val, context);
              },
            ),
            // spacer30Height,
            // CustomBottomButton(
