...
List<WAWalkThroughModel> waWalkThroughList() {
  ...
  list.add(WAWalkThroughModel(
      ...
      image: 'assets/images/walletApp/wa_walkthorugh.png'));
  list.add(WAWalkThroughModel(
      title: "Mange Anytime",
      description:
          "Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out print, graphic or web designs.",
...
List<WAOperationsModel> waOperationList() {
  ...
  operationModel.add(WAOperationsModel(
      color: Color(0xFF6C56F9),
      title: 'Top Up',
      image: 'assets/images/walletApp/wa_ticket.png',
      // Home(),
      widget: AddMoneyScreen()));
  operationModel.add(WAOperationsModel(
    color: Color(0xFF6C56F9),
    title: 'Transfer',
    image: 'assets/images/walletApp/wa_transfer.png',
// widget: LOgeer()
  ));
  operationModel.add(WAOperationsModel(
    color: Color(0xFFFF7426),
    title: 'Vouchers',
    image: 'assets/images/walletApp/wa_voucher.png',
    // widget: LOgeer()
    // WAVoucherScreen(),
  ));
  operationModel.add(WAOperationsModel(
    color: Color(0xFF26C884),
    title: 'Bill Pay',
    image: 'assets/images/walletApp/wa_bill_pay.png',
    // WABillPayScreen(),
    // widget: Profile()
  ));
  operationModel.add(WAOperationsModel(
...
List<WARecentPayeesModel> waRecentPayeesList() {
  ...
  list.add(WARecentPayeesModel(
      image:
          'https://encrypted-tbn0.gstatic.com/imagesq=tbn:ANd9GcT5yt4pfdz3-lacajgUY5xuRuciElEaMZa9luc29Vgx2oVLDQceaFmxgcUXRzU-IfTZcWA&usqp=CAU',
      name: 'Willam',
      number: '456123522'));
  list.add(WARecentPayeesModel(
      image:
  ...
  list.add(WARecentPayeesModel(
      image:
          'https://encrypted-tbn0.gstatic.com/imagesq=tbn:ANd9GcQIuNPlLLXKdjlBivtZzQxsq-hW9E6YbooFXqDqST7AfuSHGcN45DIDTi5qeLOQHNrNR9g&usqp=CAU',
      name: 'Rose',
      number: '4561222222'));
  list.add(WARecentPayeesModel(
      image:
          'https://encrypted-tbn0.gstatic.com/imagesq=tbn:ANd9GcSw9jzCKDNeX4QbAQOAABXMML3djP3ZVEv1-rpbKgfyNCshsC-zhB3Ta2JXdMxvvSOFszg&usqp=CAU',
      name: 'Bella',
      number: '98561233'));
  return list;
}
...
List<WABillPayModel> waBillPayList() {
  ...
  list.add(WABillPayModel(
      title: 'Water',
      color: Colors.blue,
      image: 'assets/images/walletApp/wa_water.png'));
  list.add(WABillPayModel(
      title: 'Gas',
      color: Color(0xFFFF7426),
      image: 'assets/images/walletApp/wa_gas.png'));
  list.add(WABillPayModel(
      title: 'Electricity',
      color: Colors.yellow,
      image: 'assets/images/walletApp/wa_electricity.png'));
  list.add(WABillPayModel(
      title: 'Internet',
      color: Colors.pink,
      image: 'assets/images/walletApp/wa_internet.png'));
  list.add(WABillPayModel(
      title: 'Education',
      color: Colors.green,
      image: 'assets/images/walletApp/wa_education.png'));
  list.add(WABillPayModel(
      title: 'Landline',
      color: Colors.lightBlueAccent,
      image: 'assets/images/walletApp/wa_landline.png'));
  return list;
}
...
List<WACardModel> waSendViaCardList() {
  ...
  list.add(WACardModel(
      ...
      date: '03/23',
      color: Color(0xFF6C56F9),
      image: 'assets/images/walletApp/wa_card.png'));
  list.add(WACardModel(
      balance: '\$12,23,000',
      cardNumber: '985 123 7654327',
      date: '25/23',
...
List<WAWalletUserModel> waWalletUserList() {
  ...
  list.add(WAWalletUserModel(
      image:
          "https://encrypted-tbn0.gstatic.com/imagesq=tbn:ANd9GcSXs_iIewEiaZ3tXb6n6VgaUIONS0B0HjwsqcvA3-EnnaNm0BwX216u2dZl2QTHnP7VOIU&usqp=CAU"));
  list.add(WAWalletUserModel(
      image:
          "https://encrypted-tbn0.gstatic.com/imagesq=tbn:ANd9GcTH7wtiaB5F3B2oaF5699EJCNEtPnjD57ERWKTMjN0h-gpRxrFQ1u68HzFFT3eYJFFNLr4&usqp=CAU"));
  list.add(WAWalletUserModel(
      image:
          "https://encrypted-tbn0.gstatic.com/imagesq=tbn:ANd9GcTH7wtiaB5F3B2oaF5699EJCNEtPnjD57ERWKTMjN0h-gpRxrFQ1u68HzFFT3eYJFFNLr4&usqp=CAU"));
  list.add(WAWalletUserModel(
...
List<WATransactionModel> waCategoriesList() {
  ...
  list.add(WATransactionModel(
      color: Color(0xFF26C884),
      title: 'Clothes',
      image: 'assets/images/walletApp/wa_clothes.png',
      balance: '-\$10,000',
      time: 'Today 12:30 PM'));
  list.add(WATransactionModel(
      color: Color(0xFFFF7426),
      title: 'Grocery',
      image: 'assets/images/walletApp/wa_food.png',
      balance: '-\$8,000',
      time: 'Today 1:02 PM'));
  return list;
}
...
class WACardModel {
  ...
  WACardModel(
      {this.image, this.balance, this.cardNumber, this.date, this.color});
}
